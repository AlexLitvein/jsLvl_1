...
const contProd = document.querySelector('.products');
...
function showCategory(category) {    
    let prods = products[category];
    for (let i = 0; i < prods.length; i++) {
        const htmlStr = getProductMarkup(prods[i]);
        contProd.insertAdjacentHTML('beforeend', htmlStr);
    }
}
